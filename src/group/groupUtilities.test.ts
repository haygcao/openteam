...
describe('Gemini conversation URL utilities', () => {
  ...
  it('accepts safe ChatGPT URLs as supported chat conversation URLs', () => {
    ...
    expect(isSafeSupportedChatUrl('https://www.kimi.com/chat/abc123')).toBe(true)
    expect(isSafeSupportedChatUrl('https://www.qianwen.com/chat/abc123')).toBe(true)
    ...
    expect(isSafeSupportedChatUrl('https://www.kimi.com.evil.example/chat/abc123')).toBe(false)
    expect(isSafeSupportedChatUrl('https://www.qianwen.com.evil.example/chat/abc123')).toBe(false)
    ...
    expect(getSafeSupportedChatUrl('https://www.kimi.com/chat/abc123')).toBe('https://www.kimi.com/chat/abc123')
